...
def get_pair(i):
    return (10-random.randint(1, 10), i, random.randint(0, RANGE))

RANGE = 10000000

simple_prio = []
print("Priority Enqueued 1:9, 2:9, 3:9, 4:5, 5:1")
heapq.heappush(simple_prio, (9, 1, 1))
heapq.heappush(simple_prio, (9, 2, 2))
heapq.heappush(simple_prio, (9, 3, 3))
heapq.heappush(simple_prio, (5, 4, 4))
heapq.heappush(simple_prio, (1, 5, 5))
